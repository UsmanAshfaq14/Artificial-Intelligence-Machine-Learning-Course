#Compostion
# Description: A class can be composed of other classes. This is called composition.
...
# Class EmployeeOne which does not inherit the class Salary yet we will use the method annual salary using 
# Composition 
class EmployeeOne: 
...
emp = EmployeeOne('A', 25, 10000, 1500) 
